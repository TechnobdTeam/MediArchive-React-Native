  ...
  return (
    <SafeAreaView>
      ...
      <NB.View style={{ backgroundColor: '#f3f7fa', width:'100%', height:'100%', }}>
        ...
        <NB.View style={{ backgroundColor: 'white',   marginTop:50, marginLeft:10, marginRight:10,  alignItems: 'center',  }}>
          ...
          {/* <NB.View style={{ position: 'absolute', top: 10, right: 10 }}>
            ...
            <TouchableHighlight
                    ...
                    >
                <Image source={{ uri:"https://www.t-nation.com/system/publishing/articles/10005529/original/6-Reasons-You-Should-Never-Open-a-Gym.png" }} style={[styles.profileImg, { borderColor: '#dae4ed', borderWidth:2,  }]}  />
            </TouchableHighlight>
            ...
            <NB.View style={{ flexDirection:'row' ,marginTop:15,}}>
              <NB.Text style={{ color: '#7e7e7e', fontSize: 14,}}>Start From:</NB.Text>
              <NB.Text style={{ color: Color.color_theme, fontSize: 14, marginLeft: 5 }}>27th September 2017</NB.Text>
            </NB.View>

            <NB.View style={{ flexDirection:'row' ,marginTop:5, marginBottom:20}}>
              <NB.Text style={{ color: '#7e7e7e', fontSize: 14,}}>Prescribe by:</NB.Text>
        ...
        <NB.View style={{ backgroundColor: 'white',  marginTop:0, marginLeft:10, marginRight:10, marginBottom: 5, marginTop:10}}>
            ...
            <NB.View style={{ marginTop:20, marginLeft: 10}}>
        ...
        <NB.View style={{ backgroundColor: 'white',   marginTop:0, marginLeft:10, marginRight:10, marginBottom:5, padding:15}}>
            ...
            <NB.View style={{ flexDirection:'row', justifyContent:'center', alignItems:'center', marginTop:10,marginBottom:10}}>
      ...
      <Dialog
          ...
          <NB.View style={{flexDirection: 'row', justifyContent:'space-between' }}>
            <NB.Text style={{ color:Color.color_theme, fontSize:24, width:'70%' }}>Set Reminder For Medicine Name</NB.Text>
            <TouchableHighlight
                      style={[styles.medicineContainer,{ borderColor: '#dae4ed', borderWidth:2,  }]}
                    >
                <Image source={{ uri:"https://www.t-nation.com/system/publishing/articles/10005529/original/6-Reasons-You-Should-Never-Open-a-Gym.png" }} style={[styles.medicineImg,{ borderColor: '#dae4ed', borderWidth:2,  }]}/>
            </TouchableHighlight>
          </NB.View>
          ...
          <NB.View style={{ justifyContent:'space-evenly', flexDirection:'row', marginTop:20 }}>
              <NB.View style={{ justifyContent:'center', flexDirection:'row', alignItems:'center', backgroundColor: Color.latest_color, paddingLeft:5, paddingRight:5,marginRight:10}}>
                <NB.Text style={{ color: '#6f6f6f', fontSize:18 }}>10:30 AM</NB.Text>
                <Icon name = "minus-circle" style = {{marginLeft: Platform.OS === 'ios' ? 10 : 10,fontSize: 25,color: '#f64e4e',transform: [{scaleX: I18nManager.isRTL ? -1 : 1}]}}/>
              </NB.View>

              <NB.View style={{ justifyContent:'center', flexDirection:'row', alignItems:'center', backgroundColor: Color.latest_color, paddingLeft:5, paddingRight:5,marginLeft:10}}>
                <NB.Text style={{ color: '#6f6f6f', fontSize:18 }}>10:30 AM</NB.Text>
                <Icon name = "minus-circle" style = {{marginLeft: Platform.OS === 'ios' ? 10 : 10,fontSize: 25,color: '#f64e4e',transform: [{scaleX: I18nManager.isRTL ? -1 : 1}]}}/>
          ...
          <NB.View style={{ marginLeft:10, marginRight:10, marginBottom: 5,  marginTop:40}}>
            ...
            <NB.View style={{ flexDirection:'row' ,marginTop:5 , justifyContent:'space-between'}}>
                <ImageBackground source={require('../images/dateback.png')} style={{width: 80,   }}>
                  <NB.Text style={{ color: '#6f6f6f', fontSize: 18,  marginLeft:10, textAlign:'center', marginBottom:5}}>Hours</NB.Text>
                </ImageBackground>

                <ImageBackground source={require('../images/dateback.png')} style={{width: 80,  }}>
                  <NB.Text style={{ color: '#6f6f6f', fontSize: 18, marginRight:10 ,textAlign:'center',marginBottom:5 }}>Minutes</NB.Text>
                </ImageBackground>

                <ImageBackground source={require('../images/dateback.png')} style={{width: 80,   }}>
                  <NB.Text style={{ color: '#6f6f6f', fontSize: 18,  textAlign:'center', marginBottom:5 }}>AM</NB.Text>
                </ImageBackground>

            </NB.View>             
        </NB.View>

        <NB.View style={{ justifyContent:'center',alignItems:'center', marginTop:18 }}>
            <NB.Text style={{ color: Color.color_theme, fontSize:18,  }}>Add +</NB.Text>
        </NB.View>



        <NB.View style={{ flexDirection:'row', justifyContent:'space-between',alignItems:'center', marginTop:60, marginBottom:10 }}>
